...
somepath = Path(r"Multi-Source_RAG_Platform/data/projects/test_coordinators_data/input/raw/ACQ/ELUNA 2016 - New and Emerging Acquisition Workflows - Purchase Requests - Yoel Kortick.pdf")
